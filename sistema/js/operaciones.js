  ...
  $.ajax({
    ...
    success: function(res){
      ...
      if(res == 'error_1'){
        ...
        swal('Error', 'Por favor ingrese un usuario valida', 'warning');
      }else if(res == 'error_3'){
        swal('Error', 'El usuario y contraseña que ingresaste es incorrecta', 'error');
      }else{
  ...
  $.ajax({
    ...
    success: function(res){
      ...
      if(res == 'error_1'){
        ...
        swal('Error', 'Por favor ingresa un usuario valido', 'warning');
      }else{
        window.location.href = res ;
      }
